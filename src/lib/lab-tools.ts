...
export const labTools: LabTool[] = [
  ...
  },
  {
    ...
    title: "JWT Decoder",
    tagline: "Inspect a token's header and payload, and verify HMAC signatures.",
    category: "Security",
    kind: "utility",
  },
  {
    ...
    tagline: "SHA-1 / SHA-256 / SHA-384 / SHA-512 for text or files, computed in-browser.",
    category: "Security",
    kind: "utility",
  },
  {
    ...
    tagline: "Real entropy math, plus a cryptographically secure generator.",
    category: "Security",
    kind: "utility",
  },
  {
  ...
  },
  {
    ...
    title: "Regex Tester",
    tagline: "Live match highlighting and capture groups against the real RegExp engine.",
    category: "Developer Utilities",
    kind: "utility",
  },
  {
    slug: "diff-checker",
    href: "/lab/diff-checker",
    title: "Diff Checker",
    tagline: "Line-by-line comparison with a real LCS diff algorithm.",
    category: "Developer Utilities",
    kind: "utility",
  },
  {
    ...
    tagline: "Turn text or a URL into a downloadable QR code.",
    category: "Developer Utilities",
    kind: "utility",
  },
  {
    slug: "color-converter",
    href: "/lab/color-converter",
    title: "Color Converter",
    tagline: "Hex, RGB, and HSL, always in sync, with a live preview.",
    category: "Developer Utilities",
    kind: "utility",
  },
  {
    slug: "markdown-previewer",
    href: "/lab/markdown-previewer",
    title: "Markdown Previewer",
    tagline: "Live side-by-side Markdown rendering.",
    category: "Developer Utilities",
    kind: "utility",
  },
];
